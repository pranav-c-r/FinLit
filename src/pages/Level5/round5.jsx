  ...
  const handleOptionSelection = (optionType) => {
    ...
    switch (optionType) {
      ...
      case 'Decline Offer':
        ...
        miniEventText = "No work → More leisure, no extra income";
          ...
          <div className="bg-[#1e293b] p-4 border-b border-[#374151]">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-xl md:text-2xl font-bold text-center text-white">
                {showOptions && "Age 58–59 – Late Career Surprise"}
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-[#58cc02] font-bold text-xl">Income: ₹1L/month</p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      ...
                      <p className="col-span-2">Mini Event: Overwork → Health risk increases</p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-orange-400 font-bold text-xl">Income: ₹75K/month</p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      ...
                      <p className="col-span-2">Mini Event: Light work → Good balance</p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-red-500 font-bold text-xl">Income: ₹0</p>
                      </div>
                      <div className="text-3xl">❌</div>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      ...
                      <p className="col-span-2">Mini Event: No work → More leisure, no extra income</p>
                    </div>
                  </div>
                </div>
              )}
