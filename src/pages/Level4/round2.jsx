...
const Round2 = () => {
  ...
  const handleOptionSelection = (optionType) => {
    ...
    switch (optionType) {
      case 'Fully Support Parents':
        selectedExpense = '₹30k/month';
        selectedHappiness = '↑';
        selectedStress = '↑';
        miniEventText = "If no insurance → ₹5L bill wipes out a year’s savings.";
      ...
      case 'Partial Support + Health Insurance':
        ...
        feedbackDialogue = 'Balanced — safety net for emergencies, but you’re not burning through cash.';
        break;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1f2e] to-[#111827] text-white overflow-hidden">
      {showIntro && (
        <RoundIntroModal
          title="Round 2: Parents’ Retirement & Your Responsibility"
          ...
          <div className="bg-[#1e293b] p-4 border-b border-[#374151]">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-xl md:text-2xl font-bold text-center text-white">
                {showOptions && "Age 47–48 – Parents’ Retirement & Your Responsibility"}
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-[#58cc02] font-bold text-xl">Expense: ₹30k/month</p>
                      </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      ...
                      <p>Stress: Medium</p>
                      <p className="col-span-2">Description: Balanced — safety net for emergencies, but you’re not burning through cash.</p>
                    </div>
                  </div>
