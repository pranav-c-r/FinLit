...
const Round2 = () => {
  ...
  const saveUserProgress = async () => {
    ...
    try {
      ...
      if (docSnap.exists()) {
        await updateDoc(userProgressRef2, { "level1.round2": userChoices });
      } else {
        await setDoc(userProgressRef, { "level1": { "round2": userChoices } });
      }
      if (docSnap2.exists()) {
        await updateDoc(userProgressRef, { "level":1, "round":2, "round2_completed": true });
      } else {
        await setDoc(userProgressRef, { "level":1, "round":2, "level1": { "round2": userChoices }, "round2_completed": true });
      }
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-4">
                    <button 
                      ...
                      onClick={() => {
                        window.location.href = '/level1/round3';
                      }}
                    >
