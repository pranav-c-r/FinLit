...
const Round3 = () => {
  ...
  const handleContinue = () => {
    ...
    setShowOptions(true);
    setMascotDialogues([
      { text: "Your child is 10-12 years old. College is 6-8 years away. Education inflation is 10-15% annually. Time to get serious about education funding!", audioSrc: null }
    ]);
  ...
  const saveUserProgress = async (roundOutcome) => {
    ...
    try {
      ...
      await updateDoc(userProgressRef, {
        'level3.round3_completed': true,
        'level3.round3': roundOutcome,
        'level': 3,
        'round': 3,
      }, { merge: true });
  ...
  const handleOptionSelection = (optionType) => {
    ...
    switch (optionType) {
      case 'Premium Education Strategy':
        selectedCost = '₹5L/year';
        selectedRisk = 'High (financial strain)';
        selectedGrowth = 'Foreign university admission chances increase';
        selectedConsequence = '₹50L+ education cost but global opportunities';
        miniEventImpact = 'Talent nurtured, international opportunities';
        feedbackDialogue = 'A significant investment! This path aims for the best, but be prepared for the financial commitment.';
        break;
      case 'Smart Balanced Approach':
        selectedCost = '₹2L/year';
        selectedRisk = 'Medium';
        selectedGrowth = 'IIT/Medical preparation with backup plans';
        selectedConsequence = 'Quality education without breaking bank';
        miniEventImpact = 'Good coaching helps, regional success';
        feedbackDialogue = 'A sensible choice! Balancing quality education with financial prudence is a strong strategy.';
        break;
      case 'Minimal Investment Strategy':
        selectedCost = '₹50K/year';
        selectedRisk = 'Low (financial)';
        selectedGrowth = 'Depends entirely on child\'s self-motivation';
        selectedConsequence = 'More money for retirement, but limited opportunities';
        miniEventImpact = 'Raw talent struggles without proper guidance';
        feedbackDialogue = 'A minimalist approach. This saves money now, but places a lot of reliance on your child\'s self-drive.';
        break;
      case 'Education Loan Planning':
        selectedCost = '₹0 now, ₹20-30L loan later';
        selectedRisk = 'Child bears responsibility for their education';
        selectedGrowth = 'Child bears responsibility for their education';
        selectedConsequence = 'No current burden, but child starts career with debt';
        miniEventImpact = 'Talent discovered late, limited specialized training';
        feedbackDialogue = 'Deferring the cost. This can ease your current burden, but your child will start their career with debt.';
        break;
      default:
        break;
    }
    ...
    setMascotDialogues([
      ...
      { text: `Mini Event – Child Shows Exceptional Talent: ${miniEventImpact}`, audioSrc: null }
    ]);
    setCurrentDialogueIndex(0);
          ...
          <div className="bg-[#1e293b] p-4 border-b border-[#374151]">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-xl md:text-2xl font-bold text-center text-white">
                {showOptions && "Age 40–41 – Kids' Education Investment"}
            ...
            <div className="max-w-2xl mx-auto">
              ...
              {showOptions && (
                <div className="space-y-4">
                  {/* Option 1: Premium Education Strategy */}
                  <div 
                    ...
                    onClick={() => handleOptionSelection('Premium Education Strategy')}
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3 className="text-lg md:text-xl font-bold text-white mb-1">Premium Education Strategy</h3>
                        <p className="text-[#58cc02] font-bold text-xl">Cost: ₹5L/year</p>
                      </div>
                      <div className="text-3xl">🎓</div>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      <p>Risk: High (financial strain)</p>
                      <p>Growth: Foreign university admission chances increase</p>
                      <p className="col-span-2">Consequence: ₹50L+ education cost but global opportunities</p>
                    </div>
                  </div>
                  
                  {/* Option 2: Smart Balanced Approach */}
                  <div 
                    className="bg-gradient-to-r from-[#1e293b] to-[#2d3748] p-5 rounded-2xl border-2 border-[#374151] hover:border-[#58cc02] active:scale-95 transition-all cursor-pointer shadow-lg hover:shadow-xl"
                    onClick={() => handleOptionSelection('Smart Balanced Approach')}
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3 className="text-lg md:text-xl font-bold text-white mb-1">Smart Balanced Approach</h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      <p>Risk: Medium</p>
                      <p>Growth: IIT/Medical preparation with backup plans</p>
                      <p className="col-span-2">Consequence: Quality education without breaking bank</p>
                    </div>
                  </div>

                  {/* Option 3: Minimal Investment Strategy */}
                  <div 
                    className="bg-gradient-to-r from-[#1e293b] to-[#2d3748] p-5 rounded-2xl border-2 border-[#374151] hover:border-[#58cc02] active:scale-95 transition-all cursor-pointer shadow-lg hover:shadow-xl"
                    onClick={() => handleOptionSelection('Minimal Investment Strategy')}
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3 className="text-lg md:text-xl font-bold text-white mb-1">Minimal Investment Strategy</h3>
                        <p className="text-red-500 font-bold text-xl">Cost: ₹50K/year</p>
                      </div>
                      <div className="text-3xl">🧑‍🎓</div>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      <p>Risk: Low (financial)</p>
                      <p>Growth: Depends entirely on child's self-motivation</p>
                      <p className="col-span-2">Consequence: More money for retirement, but limited opportunities</p>
                    </div>
                  </div>

                  {/* Option 4: Education Loan Planning */}
                  <div 
                    className="bg-gradient-to-r from-[#1e293b] to-[#2d3748] p-5 rounded-2xl border-2 border-[#374151] hover:border-[#58cc02] active:scale-95 transition-all cursor-pointer shadow-lg hover:shadow-xl"
                    onClick={() => handleOptionSelection('Education Loan Planning')}
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3 className="text-lg md:text-xl font-bold text-white mb-1">Education Loan Planning</h3>
                        <p className="text-purple-400 font-bold text-xl">Cost: ₹0 now, ₹20-30L loan later</p>
                      </div>
                      <div className="text-3xl">💸</div>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      <p>Risk: Child bears responsibility for their education</p>
                      <p>Growth: Child bears responsibility for their education</p>
                      <p className="col-span-2">Consequence: No current burden, but child starts career with debt</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {showSummary && (
                <div className="space-y-6">
                  <div className="text-center py-6">
                    ...
                    <p className="text-gray-300">You've made a crucial decision about your child's education.</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-[#1e293b] to-[#2d3748] p-6 rounded-2xl border-2 border-[#374151] shadow-xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="bg-white/5 p-4 rounded-xl">
                        ...
                        <p className="font-bold text-white text-lg">
                          <span className={`px-2 py-1 rounded-full text-xs ${
                            userChoices.risk === 'Low (financial)' ? 'bg-green-500/20 text-green-400' :
                            userChoices.risk === 'Medium' ? 'bg-yellow-500/20 text-yellow-400' :
                            userChoices.risk === 'High (financial strain)' || userChoices.risk === 'Child bears responsibility for their education' ? 'bg-red-500/20 text-red-400' :
                      ...
                      <div className="bg-white/5 p-4 rounded-xl col-span-2">
                        <p className="text-gray-400 text-sm mb-1">Mini Event Impact (Child Shows Exceptional Talent)</p>
                  ...
                  <div className="bg-gradient-to-r from-[#58cc02]/10 to-[#2fa946]/10 p-6 rounded-2xl border-2 border-[#58cc02]/30">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      "Planning for your child's education early is vital, given rising costs. Each strategy has its pros and cons, impacting both your finances and their future opportunities."
                    </p>
                  </div>
                  ...
                  <div className="pt-4">
                    <button 
                      ...
                      onClick={() => {
                        window.location.href = '/level3/round4';
                      }}
                    >
