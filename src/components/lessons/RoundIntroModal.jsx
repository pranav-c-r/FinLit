    ...
    <div className="bg-[#0A1F14] rounded-2xl shadow-lg max-w-md w-full px-6 py-8 relative flex flex-col gap-6 animate-fadeInUp border border-[#1C3B2A]">
      ...
      <div>
        ...
        <p className="text-[#80A1C1] leading-snug">
          In this round, you'll discover how your first job choice shapes your entire financial future.
          Every decision has trade-offs&nbsp;&mdash;&nbsp;stability vs. growth, immediate money vs. long-term potential.
        </p>
      </div>
      {/* Section: Challenge */}
      <div>
