...
const Round5 = () => {
  ...
  const handleGuideComplete = () => {
    setShowGuide(false);
    setMascotDialogues([
      { text: "The mirror doesn’t lie anymore. Wrinkles, knee pain, fatigue — your body is asking for attention. Do you answer?", speaker: "Mascot" },
    ]);
  ...
  const handleOptionSelection = (optionType) => {
    ...
    switch (optionType) {
      case 'Ignore Health, Keep Working':
        ...
        selectedRisk = 'High';
        miniEventText = "Health Scare: If unhealthy → Heart surgery (₹10L gone, Health ↓↓).";
        feedbackDialogue = 'You’re rich but broken. Family watches helplessly.';
        break;
      case 'Invest in Health (Gym, Diet, Yoga, Checkups)':
        ...
        selectedHappiness = '↑↑';
        selectedRisk = 'Low';
        miniEventText = "Health Scare: If healthy → You escape with just meds, doctor praises your discipline.";
          ...
          <div className="bg-[#1e293b] p-4 border-b border-[#374151]">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-xl md:text-2xl font-bold text-center text-white">
                {showOptions && "Age 53–54 – Health vs Wealth"}
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      <p>Health: ↓↓</p>
                      <p>Happiness: Low</p>
                      <p className="col-span-2">Description: You’re rich but broken. Family watches helplessly.</p>
                    </div>
                  </div>
