  ...
  const handleOptionSelection = (optionType) => {
    ...
    switch (optionType) {
      case 'Buy Health Insurance Now':
        selectedCost = '₹50K/year premium';
        selectedRisk = 'Low';
        miniEventText = "Basic Insurance → Covers 60%, some bills left";
        feedbackDialogue = 'Late entry, high premium. But one health event and it pays for itself.';
        break;
      case 'Pay Bills from Savings':
        selectedCost = '₹5L for current treatment';
        selectedRisk = 'Medium';
        miniEventText = "No insurance → Another hospital visit wipes out savings";
        feedbackDialogue = 'You pay now, but what about the next time?';
        break;
      case 'Buy Critical Illness + Health Combo':
        selectedCost = '₹75K/year';
        selectedRisk = 'Low';
        miniEventText = "Combo Insurance → Covers almost everything, saves family stress";
          ...
          <div className="bg-[#1e293b] p-4 border-b border-[#374151]">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-xl md:text-2xl font-bold text-center text-white">
                {showOptions && "Age 55–56 – Health Scare"}
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-[#58cc02] font-bold text-xl">Cost: ₹50K/year premium</p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      ...
                      <p className="col-span-2">Mini Event: Basic Insurance → Covers 60%, some bills left</p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-orange-400 font-bold text-xl">Cost: ₹5L for current treatment</p>
                      </div>
                      <div className="text-3xl">💸</div>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      ...
                      <p className="col-span-2">Mini Event: No insurance → Another hospital visit wipes out savings</p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-red-500 font-bold text-xl">Cost: ₹75K/year</p>
                      </div>
                      <div className="text-3xl">🧡</div>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
                      ...
                      <p className="col-span-2">Mini Event: Combo Insurance → Covers almost everything, saves family stress</p>
                    </div>
                  </div>
