  ...
  return (
    <div className="user-stats">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="stat-card p-4 bg-[#0C291C] rounded-xl transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
      ...
      <div className="mt-4 p-4 bg-[#0C291C] rounded-xl">
        <div className="flex items-center justify-between mb-2">
